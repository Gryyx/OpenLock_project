# OpenLock_project
An extremely lightweight background app initially built using Claude for cooperative screen time limitation &amp; app blocking on a Windows PC.

It blocks a list of programs you choose, during a time window you choose, and can start automatically when you log in.

**This is for self-imposed limits, not for blocking a determined user or adversary.**
